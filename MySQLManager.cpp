...
bool MySQLManager::SyncUserInfo(uint16_t userPk_) {
...
bool MySQLManager::SyncEquipment(uint16_t userPk_) {
...
bool MySQLManager::SyncConsumables(uint16_t userPk_) {
...
bool MySQLManager::SyncMaterials(uint16_t userPk_) {
